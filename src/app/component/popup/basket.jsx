...
export default function PopUpBasket({ onBasketClose }) {
    ...
    return (<div onClick={() => {
        ...
        {isOpen && !opendeal && (<div className=' lg:flex  fixed inset-0 items-center justify-center z-50 overflow-scroll flex flex-col  bg-black/50 '>
            ...
            <div onClick={(e) => e.stopPropagation()} className=' max-w-[378px]  bg-white  w-full border-[#BCBCBC] border-[1px] rounded-[12px] flex flex-col'>
                ...
                <div></div>
                {cart.map((item, id) => (<div key={id} className=' flex flex-row justify-center items-center cursor-pointer  pt-[25px] border-b-[1px]  border-[#00000033]'>
                    <button className=" w-[45px] h-[45px]  justify-center bg-[#FC8A06] rounded-full items-center  font-[Poppins] font-[700]  text-[24px]  leading-[100%] tracking-[0em]  text-white  flex ">{`${item.quantity}X `}</button>
                    <div className='cursor-pointer ml-[27px] flex flex-col gap-y-[6px] max-w-[178px] mb-[24px]'>
                ...
                <div>
                    <div className=' cursor-pointer mx-[12px] flex flex-row  mt-[34px]  items-center justify-center  gap-x-[40px] rounded-[8px] min-w-[342px] min-h-[70px] bg-[#FC8A06CC]/80 '><h1 className=' font-[Poppins] font-[600]  text-[20px]  leading-[100%] tracking-[0em] text-white'>Total Pay</h1> <h1 className=' font-[Poppins] font-[600]  text-[36px]  leading-[25px] tracking-[0em] text-white'>{`£ ${subTotal.toFixed(2)}`}</h1></div>
                    <div className='px-[12px] border-b-1 border-[#00000033]'>
                        <div className="flex flex-row max-w-[342px]  justify-between max-h-[52px] mx-auto pb-[13px] pl-[40px] pr-[17px] pt-[15px] mt-[21px] rounded-l-full  rounded-r-full border-[1px]  border-[#00000066]  border-opacity-[20%]">
                            <input
                                type="text"
                                placeholder="Choose your free item.."
                                className=" text-[#000000CC] cursor-pointer focus:outline-none focus:ring-0 focus:border-transparent"
                            />  <Image src="/assets/icons/Forward Button (1).svg" className=" rotate-y-180  " width={30} height={30} alt="" />
                        </div>

                        <div className="flex flex-row max-w-[342px] mb-[37px]  justify-between max-h-[52px] mx-auto pb-[13px] pl-[40px] pr-[17px] pt-[15px] mt-[21px] rounded-l-full  rounded-r-full border-[1px]  border-[#00000066]  border-opacity-[20%]">
                            <input
                                type="text"
                                placeholder="Apply Coupon Code here"
                                className=" text-[#000000CC] cursor-pointer focus:outline-none focus:ring-0 focus:border-transparent"
                            />  <Image src="/assets/icons/ForwardButtonGreen.svg" className="   " width={30} height={30} alt="" />
                        </div>

                    </div>

                    <div className=' min-w-[158px] min-h-[115px] flex flex-row gap-x-[12px]  items-center  justify-center mx-auto mt-[17px]' >
                        <div className=' cursor-pointer min-w-[158px] min-h-[115px] border-[1px] border-[#00000033]  rounded-[12px] flex  flex-col justify-center items-center'>
                        ...
                        <div className='cursor-pointer min-w-[158px] min-h-[115px]  rounded-[12px] flex flex-col justify-center items-center'>
                            <Image src="/assets/icons/Delivery Scooter.svg" width={35} height={35} alt="" />
                            <h1 className=' font-[Poppins] font-[600]  text-[16px]  leading-[25px] tracking-[0em] '>Collection</h1>
                            <h1 className=' font-[Poppins] font-[400]  text-[15px]  leading-[25px] tracking-[0em] '>Start at 16:50</h1>
                        </div>
                    </div>
                    ...
                    <div onClick={() => {
                        setIsOpen(false);
                        setopendeal(true);
                    }} className=' w-[342px] cursor-pointer h-[70px] items-center  mb-[10px] mx-auto flex rounded-[8px] mt-[17px] bg-[#028643]'>
                        ...
                        <span className="   text-[24px]  leading-[100%] tracking-[0em] text-white font-[Poppins] font-[600] ml-[53px]  text-center">
                            Checkout!
                        </span>
                    </div>
                    <div className=' justify-center  mx-auto flex items-center relative w-[342px] mb-[30px] bg-[#03081F] mt-[20px] rounded-[8px]'>
                        ...
                        <p className=' font-[Poppins]  cursor-pointer rounded-[8px] text-white text-center font-[600] text-[17px] leading-[120%] px-[19px] py-[22px]'>We are open now, but delivery starts at <span className='text-[#FC8A06]'>18:00</span>  however you may order and collect in store now</p>
                    </div>
