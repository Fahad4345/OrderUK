...
export default function RightBasket() {
  ...
  return (<div >
    ...
    <div className='sm:hidden lg:flex flex flex-col items-center '>
      ...
      <div onClick={(e) => e.stopPropagation()} className=' max-w-[378px]  bg-white  w-full border-[#BCBCBC] border-[1px] rounded-[12px] flex flex-col'>
        ...
        <div>
          ...
          <div className=' justify-center  mx-auto flex items-center relative w-[342px] mb-[30px] bg-[#03081F] mt-[30px] rounded-[8px]'>
...
//   const item = [{ Price: "£27.90", type: "12” Vegitarian Pizza ", message: "No Mushrooms + green peppers" },
...
//       <div className=' max-w-[378px] min-h-[1078px]   w-full border-[#BCBCBC] border-[1px]  bg-white  z-50 rounded-[12px] flex flex-col'>
//         <div className='pl-[34px] pb-[48px] items-center flex gap-[20px] pt-[49px] bg-[#028643] rounded-t-[12px] '>
//           <Image src="/assets/icons/Full shopping Basket.svg" width={55} height={55} alt="" />
//           <h1 className=' font-[Poppins] font-[600]  text-[32px]  leading-[100%] tracking-[0em] text-white'> My Basket</h1>
//         </div>
...
//         </div>))}
//         <div className=' pl-[27px] flex flex-col gap-y-[16px] mt-[34px] pb-[24px] border-b-[1px]  border-[#00000033] bg-white'>
//           <div className=' flex flex-row justify-between  w-[320px]' >
//             <p className=' font-[Poppins] font-[600]  text-[20px]  leading-[100%] tracking-[0em]'>Sub Total:</p>
...
//           </div>
//         </div>
//         <div className=' mx-[12px] flex flex-row  mt-[34px]  items-center justify-center  gap-x-[40px] rounded-[8px] min-w-[342px] min-h-[70px] bg-[#FC8A06CC]/80 '><h1 className=' font-[Poppins] font-[600]  text-[20px]  leading-[100%] tracking-[0em] text-white'>Total Pay</h1> <h1 className=' font-[Poppins] font-[600]  text-[36px]  leading-[25px] tracking-[0em] text-white'>£127.90</h1></div>
//         <div className='px-[12px] border-b-1 bg-white border-[#00000033]'>
//           <div className="flex flex-row max-w-[342px]  max-h-[52px] mx-auto  mt-[21px] rounded-l-full  rounded-r-full border-[1px]  border-[#00000066]  border-opacity-[20%]">
//             <input
//               type="text"
//               placeholder="Choose your free item.."
...
//             />
//           </div> </div>
//         <div className='  bg-white min-w-[158px] min-h-[115px] flex flex-row gap-x-[12px]  items-center  justify-center mx-auto mt-[17px]' >
...
//         <div onClick={() => setIsOpen(true)} className=' w-[342px] h-[70px] items-center  mb-[10px] mx-auto flex rounded-[8px] mt-[17px] bg-[#028643]'>
