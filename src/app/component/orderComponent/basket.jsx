  ...
  return (
    <div className='sm:hidden lg:flex  flex flex-col'>
      ...
      <div className=' max-w-[378px] min-h-[1078px]   w-full border-[#BCBCBC] border-[1px]  bg-[#F9F9F9] rounded-[12px] flex flex-col'>
        ...
        <div className=' mx-[12px] flex flex-row  mt-[34px]  items-center justify-center  gap-x-[40px] rounded-[8px] min-w-[342px] h-[70px] bg-[#FC8A06CC]/80 '><h1 className=' font-[Poppins] font-[600]  text-[20px]  leading-[100%] tracking-[0em] text-white'>Total Pay</h1> <h1 className=' font-[Poppins] font-[600]  text-[36px]  leading-[25px] tracking-[0em] text-white'>£127.90</h1></div>
