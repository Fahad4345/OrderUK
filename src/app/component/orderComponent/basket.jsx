...
export default function PopUpBasket({ onBasketClose }) {
  ...
  return (<div  >
    ...
    {isOpen && !opendeal && (<div className=' sm:hidden xl:hidden 2xl:flex flex flex-col items-center '>
      <div className=' mb-[21px] bg-[#FC8A06]  w-full flex min-h-[125px] flex-row rounded-[12px] gap-[21px] items-center justify-center'>
      ...
      <div onClick={(e) => e.stopPropagation()} className=' max-w-[378px]  bg-white  w-full border-[#BCBCBC] border-[1px] rounded-[12px] flex flex-col'>
        <div className=' pb-[21px] items-center flex justify-center gap-[20px] pt-[49px] bg-[#028643] rounded-t-[12px] '>
        ...
        <div>
          <div className=' mx-[12px] flex flex-row  mt-[34px]  items-center justify-center  gap-x-[40px] rounded-[8px] min-w-[342px] cursor-pointer min-h-[70px] bg-[#FC8A06CC]/80 '><h1 className=' font-[Poppins] font-[600]  text-[20px]  leading-[100%] tracking-[0em] text-white'>Total Pay</h1> <h1 className=' font-[Poppins] font-[600]  text-[36px]  leading-[25px] tracking-[0em] text-white'>{`£ ${subTotal.toFixed(2)}`}</h1></div>
          <div className='px-[12px] border-b-1 border-[#00000033]'>
            <div className="flex flex-row max-w-[342px]  justify-between max-h-[52px] mx-auto pb-[13px] pl-[40px] pr-[17px] pt-[15px] mt-[21px] rounded-l-full  rounded-r-full border-[1px]  border-[#00000066]  border-opacity-[20%]">
              <input
                ...
                className=" text-[#000000CC] focus:outline-none focus:ring-0 focus:border-transparent"
          ...
          <div className='  disabled: min-w-[158px] min-h-[115px] flex flex-row gap-x-[12px]  items-center  justify-center mx-auto mt-[17px]' >
            ...
            <div className=' cursor-pointer min-w-[158px] min-h-[115px]  rounded-[12px] flex flex-col justify-center items-center'>
              <Image src="/assets/icons/New Store.svg" width={35} height={35} alt="" />
          ...
          <div className=' justify-center cursor-pointer mx-auto flex items-center relative w-[342px] mb-[30px] bg-[#03081F] mt-[20px] rounded-[8px]'>
