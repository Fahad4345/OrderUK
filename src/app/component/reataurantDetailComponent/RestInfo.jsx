...
export default function RestInfo() {
  ...
  return (
    <div className="max-w-[1528px]  min-h-[659px] w-full rounded-[12px]  flex flex-row mx-auto mt-[151px] shadow-[5px_5px_14px_0px_rgba(0,0,0,0.25)] bg-[#FBFBFB]">
        ...
        <div key={index}className={` flex flex-col pt-[122px] max-w-[496px] w-full  h-full  pl-[63px] rounded-[12px] ${
    section.category === "Operational Times" ? "bg-black text-white" : ""
  }`}>
          <div className="flex items-center  mb-[42px]">
            <Image src={section.icon} alt={section.category} width={45} height={45} />
            <h2 className={`font-[Poppins]  ml-[11px] font-[700] text-[24px] text-[#000000] ${
    section.category === "Operational Times" ? "bg-black text-white" : ""}`}>{section.category}</h2>
          </div>
