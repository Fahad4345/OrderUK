...
export default function Banner() {
    ...
    return (
        <div className='sm:max-w-[calc(100vw_-_22px)] lg:max-w-[1528px]  mt-[41px] w-full   sm:mx-auto rounded-[12px]'
            ...
            <div className='max-w-[1528px] flex-wrap   sm:justify-center lg:justify-start flex flex-row w-full lg:h-[477px] sm:h-[593px] mx-auto rounded-[12px] bg-[#E2E2E2E5]/90'>
                ...
                <div className=" lg:ml-[57px] lg:pt-[171px] "><p className=" font-[Poppins] font-[400] lg:text-[20px] sm:text-[13px]  sm:text-center lg:text-start  tracking-[0em] text-[#000000]">Desi Flavours with a blend of Italian aesthetics!</p>
                    <h1 className=" font-[Poppins] font-[700] lg:text-[44px] sm:text-[28px] sm:text-center lg:text-start leading-[66px] tracking-[0em] text-[#000000]">{restaurants[index].name}</h1>
