        ...
        <div className="  bg-[#FC8A06] w-[626px] relative  h-[565px]  rounded-tl-[282.5px] rounded-br-[12px] mt-[44px]">
          <div className="  z-50 absolute top-[70px] left-[130px] bg-white max-w-[370px]   w-full   flex flex-row  justify-between  rounded-[12px] px-[20px] py-[20px]">
            ...
            <div className=" flex flex-col">
              ...
              />
              <span className=" mt-[10px] font-[Poppins] font-[600] text-[12px] leading-[100%] tracking-[-0.06em] text-[#000000]">
                We’ve Received your order!
              </span>
              <p className="font-[Poppins] mt-[5px] font-[400] text-[12px] leading-[100%] tracking-[-0.06em] text-black/80">
                Awaiting Restaurant acceptance{" "}
              </p>
            </div>
            <h1 className="font-[Poppins] font-[400] text-[12px] leading-[100%] tracking-[-0.06em] text-[#000000]">
              now
            </h1>
          </div>
