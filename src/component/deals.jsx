    ...
    <div className=" max-w-[1528px] w-full mx-auto mt-[54px]">
      <div className=" flex  justify-between  items-center">
        ...
        <div className="  max-w-[537px] w-full flex  justify-between">
          <button className="font-[Poppins] font-[400px] text-[16px] leading-[100%] tracking-[0%]">
            Vegan
          </button>
          <button className="font-[Poppins] font-[400px] text-[16px] leading-[100%] tracking-[0%]">
            Sushi
        ...
        {deals.map((deal, index) => (
          ...
          >
            ...
            <div className=" max-w-[88px] w-full min-h-[66px]  h-full bg-[#03081F]  rounded-b-[12px]  ml-[388px]  flex justify-center items-center">
              <h1 className="font-[Poppins] font-[700px] text-[18px] leading-[100%] tracking-[0%] text-white">
                {deal.Off}
              </h1>
            </div>
            <div className="  z-50 ml-[48px] mb-[36px] ">
              <h1 className="font-[Poppins] font-[500px] text-[18px] leading-[100%] tracking-[0%] text-[#FC8A06]">
                Restaurant
              </h1>
              <h1 className="font-[Poppins] font-[700px] text-[24px] leading-[100%] tracking-[0%] text-[#FFFFFF]">
                {deal.restaurantName}
              </h1>
                </div>
